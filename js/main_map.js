...
function onEachFeature(feature, layer) {
    var popupContent = "<div class=\"p-3 mb-2 bg-primary text-white\">Propriétées</div>";
...
function addList1(geoJsonData) {
    ...
    for (var i = 0; i < geoJsonData.features.length; i++) {
        ...
        $("ul#list1").prepend("<li class='geoJsonData' style=\"font-size:15px;color: white\" data-lat='" + lat + "' data-lng='" + lng + "'> id: " + geoJsonData.features[i].id + " - Nom: " + geoJsonData.features[i].properties.nom_client + " - Adresse: " + geoJsonData.features[i].properties.adresse_client + " - Distance: " + distance + " Km " + "</li>");
    }
}
...
function addList2(geoJsonData) {
    ...
    for (var i = 0; i < geoJsonData.features.length; i++) {
        ...
        $("ul#list2").prepend("<li class='geoJsonData' style=\"font-size:15px;color: white\" data-lat='" + lat + "' data-lng='" + lng + "'> id: " + geoJsonData.features[i].id + " - Nom: " + geoJsonData.features[i].properties.nom_ville + " - Code Postal : " + geoJsonData.features[i].properties.cp_ville + " - Distance: " + distance + " Km " + "</li>");
    }
}
...
function addList3(geoJsonData) {
    ...
    for (var i = 0; i < geoJsonData.features.length; i++) {
        ...
        $("ul#list3").prepend("<li class='geoJsonData' style=\"font-size:15px;color: white\" data-lat='" + lat + "' data-lng='" + lng + "'> id: " + geoJsonData.features[i].id + " - Depart: " + geoJsonData.features[i].properties.point_depart_troncon + " - Arrivée : " + geoJsonData.features[i].properties.point_arrivee_troncon + " - Distance: " + distance + " Km " + "</li>");
    }
}
